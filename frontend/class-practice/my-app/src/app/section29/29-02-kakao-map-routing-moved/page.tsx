...
export default function KakaoMapPage() {
  ...
  useEffect(() => {
    ...
    // kakao load 기다리기 => outoload=false => ? 뒤에 옵션 주기: 쿼리스트링, 옵션은 key=value 구조로 &로 연결해서 사용
    script.src =
      "//dapi.kakao.com/v2/maps/sdk.js?appkey=959ac9a4786dc353312c2ff249f5b0d7&autoload=false";
    // script는 Head 안에 있으니까 자식으로 script를 사이에 넣어주는 코드
